...
public class BaseController {
    ...
    protected static String renderJsonSuccess() {
        return JsonUtil.getJson(new BaseAjaxResult());
    }

    protected static BaseAjaxResult renderJsonSuccessed(boolean success, int code, String msg) {
        return new BaseAjaxResult(success, code, msg);
    }
    ...
    protected static String renderJsonAjaxResult(String obj) {
